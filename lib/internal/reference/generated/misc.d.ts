...
export declare type Operation = InferOperationIndex<current_customer.paths> & InferOperationIndex<customer_login.paths> & InferOperationIndex<orders.paths> & InferOperationIndex<payment_processing.paths> & InferOperationIndex<shipping_provider.paths> & InferOperationIndex<tax_provider.paths>;
