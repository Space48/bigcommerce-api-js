...
export interface components {
    readonly schemas: {
        ...
        readonly orderProducts: {
            ...
            readonly option_set_id?: {
                readonly [key: string]: any;
            };
            /** ID of a parent product. */
            readonly parent_order_product_id?: {
                readonly [key: string]: any;
            };
        ...
        readonly orderShipment: {
            ...
            readonly shipping_provider?: "auspost" | "canadapost" | "endicia" | "usps" | "fedex" | "ups" | "upsready" | "upsonline" | "shipperhq" | " ";
            /**
        ...
        readonly order_Put: {
            readonly products?: readonly (Partial<components["schemas"]["orderCatalogProduct_Put"]> & Partial<components["schemas"]["orderCustomProduct_Put"]>)[];
        ...
        readonly order_Post: {
            readonly products?: readonly (Partial<components["schemas"]["orderCustomProduct_Post"]> & Partial<components["schemas"]["orderCatalogProduct_Post"]>)[];
        ...
        readonly "actual-order-response": {
            readonly content: {
                readonly "application/json": {
                    ...
                    readonly handling_cost_ex_tax?: string;
                    /** The value of the handling cost, including tax. (Float, Float-As-String, Integer) */
                    readonly handling_cost_inc_tax?: {
                        readonly [key: string]: any;
                    };
                    /** A read-only value. Do not attempt to modify or set this value in a POST or PUT operation. (Float, Float-As-String, Integer) */
                    readonly handling_cost_tax?: string;
    ...
    readonly parameters: {
        ...
        readonly payment_method: "Manual" | "Cash on Delivery" | "Credit Card" | "Test Payment Gateway" | "Pay In Store";
        /**
