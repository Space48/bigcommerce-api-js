...
export declare type Operation = InferOperationIndex<carts.paths> & InferOperationIndex<checkouts.paths> & InferOperationIndex<customers.paths> & InferOperationIndex<form_fields.paths> & InferOperationIndex<orders.paths> & InferOperationIndex<pricing.paths> & InferOperationIndex<subscriptions.paths>;
