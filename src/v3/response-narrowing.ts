...
type Includes<Op extends Operation> = 
  Op['parameters'] extends { query?: { include?: infer T } }
...
type NarrowData<
  Data,
  Query extends Record<string, any> | undefined,
  Includes extends string,
> = 
...
type NarrowFields<Data, Query extends Record<string, any> | undefined> = 
  Query extends { include_fields: ReadonlyArray<infer F> }
    ? Pick<Data, (F | 'id') & keyof Data>
  : Query extends { exclude_fields: ReadonlyArray<infer F | 'id'> }
    ? Omit<Data, F & keyof Data>
  : Data

type NarrowIncludes<Data, Query extends Record<string, any> | undefined> =
  Query extends { include: ReadonlyArray<infer F> }
